...
class ModelTrain extends Component {
  componentWillMount = () => {
    console.info('挂载模型训练，清空数据');
    ds.setDataSource(null);
  }
  render() {
    return (
      <div className={classNames(styles.ModelTrain, 'page', this.props.className)}>
        <AntDCard>
          <SearchForm ds={ds}/>
          <Table ds={ds}/>
        </AntDCard>
...
ModelTrain.defaultProps = {

};

const InjectModelTrain = inject()(ModelTrain);
