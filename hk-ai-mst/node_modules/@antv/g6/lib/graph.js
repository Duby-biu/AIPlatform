...
var Mixins = [FilterMixin, MappingMixin, QueryMixin, AnimateMixin, DrawMixin, ForceFit, LayoutMixin, FitView, EventMixin, ModeMixin];
var TAB_INDEX = 20;
...
function (_Base) {
  ...
  _proto.addItems = function addItems(type, models) {
    var _this4 = this;
  ...
  _proto.removeItems = function removeItems(items) {
    var dataMap = this.get('_dataMap');
    var itemMap = this.get('_itemMap');
  ...
  _proto.updateItem = function updateItem(item, model) {
    Util.mix(item.getModel(), model); // if update edge source or target re cache edges.
  ...
  _proto.forcePreventAnimate = function forcePreventAnimate(bool) {
  ...
  _proto.update = function update(item, model) {
    ...
    this.updateItem(item, model); // If the update nodes or group, update their parent
  ...
  _proto._tryShowEdge = function _tryShowEdge(edge) {
  ...
  _proto.saveImage = function saveImage() {
