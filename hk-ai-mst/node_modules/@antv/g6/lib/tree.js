    ...
    if (item.isNode) {
      ...
      if (Util.isArray(model.children)) {
        ...
        Util.each(model.children, function (child) {
          ...
          _this2.addItems('node', data.nodes);

          _this2.addItems('edge', data.edges);

          !child.parent && _this2.addItems('edge', [{
